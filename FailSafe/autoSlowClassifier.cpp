...
void SlowClassifier::initialize()
{
   ...
   mThresholderM2.initialize(&Auto::gAutoParms.mThresholderParmsM2);
   mThresholderM1.initialize(&Auto::gAutoParms.mThresholderParmsM1);
   mThresholderP1.initialize(&Auto::gAutoParms.mThresholderParmsP1);
   mThresholderP2.initialize(&Auto::gAutoParms.mThresholderParmsP2);
}
